    ...
    return (
        <ImageBackground source={cover} style={styles.container}>
            ...
            <View style={styles.body}>
                <Text style={styles.textchoose}>Choose one to Login </Text>
                <TouchableOpacity style={styles.userchoose} onPress={() => navigation.navigate("userLogin")}>
                ...
                <TouchableOpacity style={styles.adminchoose} onPress={() => navigation.navigate("adminLogin")}>
